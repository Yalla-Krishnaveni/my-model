...
def predict():
    ...
    print(output)
    if output[0] == 0:
        return render_template('index.html', pred=f'The person will not suffer from Malaria')
    else:
        return render_template('index.html', pred=f'The person will suffer from Malaria')
